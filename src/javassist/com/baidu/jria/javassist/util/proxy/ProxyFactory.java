...
public class ProxyFactory {
    ...
    private static final String NULL_INTERCEPTOR_HOLDER = "com.baidu.jria.javassist.util.proxy.RuntimeSupport";
    ...
    private ClassFile make() throws CannotCompileException {
        ...
        FieldInfo finfo3 = new FieldInfo(pool, METHOD_FILTER_FIELD,
                                            "Lcom/baidu/jria/javassist/util/proxy/MethodFilter;");
    ...
    private static MethodInfo makeWriteReplace(ConstPool cp) {
        ...
        code.addInvokestatic("javassist.util.proxy.RuntimeSupport",
                             "makeSerializedProxy",
                             "(Ljava/lang/Object;)Lcom/baidu/jria/javassist/util/proxy/SerializedProxy;");
        code.addOpcode(Opcode.ARETURN);
        minfo.setCodeAttribute(code.toCodeAttribute());
        return minfo;
    }
