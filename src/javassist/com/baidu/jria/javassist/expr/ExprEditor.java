 ...
 *
 * @see com.baidu.jria.javassist.CtClass#instrument(ExprEditor)
 * @see com.baidu.jria.javassist.CtMethod#instrument(ExprEditor)
 * @see com.baidu.jria.javassist.CtConstructor#instrument(ExprEditor)
 * @see MethodCall
 * @see NewExpr
 * @see FieldAccess
 *
